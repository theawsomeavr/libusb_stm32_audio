 ...
 * \param ep endpoint index, should belong to IN or CONTROL endpoint
...
inline static uint8_t usbd_is_configured(usbd_device *dev) {
    return dev->status.device_state == usbd_state_configured;
}
